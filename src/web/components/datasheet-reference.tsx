...
export function DatasheetReference({
  ...
  const selected_application = job.typical_applications?.applications.find(
    (application) => application.application_id === application_id,
  )
  const is_ai_generated = is_application && selected_application?.origin === "ai_generated"
      ...
      <div className="datasheet-reference-content">
        {is_ai_generated ? (
          <div className="datasheet-reference-empty">
            ...
            <p>
              This application is grounded in extracted datasheet constraints, but it is not a datasheet
              figure.
            </p>
          </div>
